...
class user45ViewController: UIViewController {
    ...
    @IBOutlet weak var takeAdviceChoice: UIButton!
    @IBOutlet weak var notChoice: UIButton!
    ...
    @IBAction func continueOnTap(_ sender: Any) {if currentPosition > lesson.count-1 { takeAdviceChoice.isHidden = false
        notChoice.isHidden = false
